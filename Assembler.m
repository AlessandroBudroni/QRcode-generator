...
[numDataBits, EC_x_block, n_data_block1, n_block1, n_data_block2, n_block2] = info_version(version,eclevel); 
...
if n_block2 == 0
    ...
    for j = 1:n_data_block1
        for i =1:n_block1

            DataArray = cat(2,DataArray,ArrayByte1(j,:,i));
    ...
    Finsequence = cat(2,DataArray,ECCArray);
    ...
    for j = 1:n_data_block1
        ...
        for i =1:n_block2
            ...
            DataArray = cat(2,DataArray,ArrayByte2(j,:,i));
    ...
    for i =1:n_block2
            ...
            DataArray = cat(2,DataArray,ArrayByte2(n_data_block2,:,i));
    ...
    for j = 1:EC_x_block
        ...
        for i =1:n_block2
            ...
            ECCArray = cat(2,ECCArray,ECCodewordByte2(j,:,i));
...
Finsequence = cat(2,DataArray,ECCArray);
    ...
    for i =1:Reminders_bit_info(version)
        
        Finsequence = cat(2,Finsequence,0);
...
function [numDataBits, EC_x_block, n_data_block1, n_block1, n_data_block2, n_block2] = info_version(version,eclevel)  
...
EC_x_block = Block_info(4*(version-1) + c,2);
